...
envsubst "\$PORTFOLIO_FRONTEND_HOST \$PORTFOLIO_FRONTEND_PORT \$PORTFOLIOBFF_HOST \$PORTFOLIOBFF_PORT \$DOMAIN" < /etc/nginx/templates/nginx.conf.template > /etc/nginx/nginx.conf
